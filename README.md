<h1 align="center" style="border-bottom: none;">hi i'm sorb</h1>
...
<table align="center">
  <tr>
    ...
    <td align="center" width="30%">
       <!-- its been like years and i will STILL LOVE ULTRAKILL -->
...
[reader](https://www.tiktok.com/@paulepick/photo/7467646890885139734?q=youtuber%20markilplioer%20comment&t=1783429677250)

hhehehehehehhehehehehehhehehehehehehhehehhehec

get it i referenced current day media to look funny

how original and eternal
...
<!-- NOBODY is gonna know that im still 15, but cmon man im like a week away from becoming an adult. FUUUCK FUUCK UFCK FUCK IM GETTING OLD ILL START WORRYING ABOUT SCHOOL AND SHIT FUUUUUUCK -->
anyways, hi. i am a 16 year old (as of 2026) wannabe programmer that **LOVES** ULTRAKILL (keyword: "**ULTRAKILL**")

boo corp slop

anyways uh here is my uncommented comment (so just a text) from above the above statement having a crisis on becoming 16:

NOBODY is gonna know that im still 15, but cmon man im like a week away from becoming an adult. FUUUCK FUUCK UFCK FUCK IM GETTING OLD ILL START WORRYING ABOUT SCHOOL AND SHIT FUUUUUUCK

i genuinely js copy pasted this lol (you would **LOVE** to see the raw markdown)

<!-- i swear im talking like i can do any of these -->
<!-- SPECIFICALLY game dev -->
<!-- i am NOT good at game dev -->

i think i like:

- programming (as if that wasnt obvious)
- game dev (ZERO actual games made btw)
- linux/ricing (you can guess my physique now)
- computers and anything related to it. so like yeah the last three bullet points didnt actually matter.
- oh did i mention ULTRAKILL. ever heard of UTLRAKILL? no? Then check out [devilmayquake.com](http://devilmayquake.com) and buy YOUR own copy of ultrakill for a mere **30$** 👀👀👀👀👀👀
- also lower case letters. why? idk bro i guess its SUPER unserious
- `larp`ing, **yes** `larp`ing. by **saying** that **i** `larp`, **i activated** a **binding vow** that **spawns** a **domain** called the **world** where **time** is **accelerated** causing **your brain** to **get hit** by a **proton flying** through the **atmosphere** making **you** think that **i never** `larp`ed causing **me** to **never** be **known** as a `larp`. on sm **death note** shi. **i** **perchance** tihnnk the **dudes** **tname** is like **yamaga** or **smth** **i** **think** **he** is **kira** like with that **weird** **explosive personality** (get it because **kira** has an **explosive** **stand**, and **stands** are like **manifestations** of **your** **soul**, so that means **his personality is explosive**. **so humourous** right). i **highlighted** the **buzzwords** so **you** `larp` with **me**
<!-- ^^^ was ultrakill really this expensive??? i swear it was like 20 or smth bucks. was it a sale? -->
<!-- holy shit im horrible -->
<!-- fuck ts looks like the big fourths of third comments, im selling myself away -->
<!-- fuck i did it again -->

am i on the spectrum or sm. like for the past 30 min ive js been typing some bullshit. including this

genuinely what was the point of this next section

Personally I am: ( SIN SIN SIN SIN SIN NORMAL WORDS I SEE SIN SIN )

- i guess nerdy?
- why am i even making this section if i have nothing to say for it?
- oh right might wanna look at the comments of this readme
- thats like the real me
- the mask lol
- - hhahahahhaha its like that one dream song im cryin
- ok maybe unserious yeahh
- - might wanna look at the last version of my readme [here](https://github.com/sorb852/sorb852/tree/d938693d1495006d2403758b392133586a4ff5cc)
- - on everone this was some real shi
...
i kinda realized i aint shit
like no where near professional or decent
so i decided to change this from "ass" "i guess" "decent" to js things i use because i have **ZERO** scale
...
| --- | --- | --- |
| ![i swear i know that im these things](https://skillicons.dev/icons?i=c,cpp,rust,js,ts,html,css,markdown,go,lua,python,godot&perline=3&theme=dark) | ![that includes everything here too, even the frameworks](https://skillicons.dev/icons?i=bash,neovim,vim,vscode,figma,cmake,git,mongo,postgres,prisma,bun,nodejs,linux,arch,nix,vite&perline=4&theme=dark) | ![really hope sm cool person would read the md raw and reach out to me teaching me how not to `larp`](https://skillicons.dev/icons?i=svelte,next,react,actix,bevy,rocket&perline=2&theme=dark) |

oh yeah i can definetly see the icons clearly, make it more white. oh yeahh smear the white all over the icon, its definetly a great idea to make the background of a whtie foreground icon white too

theres more that i use but really it doesnt matter. why? there is no skillicons for it. so it is instantly flushed down the drain of 

fuck it flushed my sentence

add some politcal thing followed by "at its best isnt it?"

### notes on peak (weird way to spell "i wanna talk about the things i like")

really i might be `larp`ing a lot of them. and you wouldnt know. bum.

yes im calling you bum. not on the same bum as yuta "my new jjk oc" okkotsu (fun fact, i have only watched a SINGLE episode of jjk, truly a `larp` arent i? so beautiful?)
...
just an excuse to write more stuff lmao

im genuinely laughing and hollering making this readme.

god blessed me with free will and made my ancestors watch me make this. signs that god exists btw (also he refilled my hair spray so its obviously a miracle)

genuinely i had so much fun making this, been ages since i expressed myself to the fullest.

I probably gave so much info about myself that you can pinpoint who i am but, atleast entertain youself with this. will you?

also if you havent bought ultrakill yet. js know its comparable to doom eternal, not saying doom is bad or ultrakill is better but saying that theres more than one cake 👀👀👀👀 whats better than one cake?? two cakes 👀👀👀👀👀👀👀
